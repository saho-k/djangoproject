...
urlpatterns = [
    ...
    path('thought/<int:pk>/', views.thought_detail, name='thought-detail'),
    path('thought/<int:thought_id>/add_comment/', views.add_comment_to_thought, name='add_comment_to_thought'),
